...
# msd_lite
git clone --depth=1 https://github.com/ximiTech/luci-app-msd_lite package-extra/luci-app-msd_lite
git clone --depth=1 https://github.com/ximiTech/msd_lite package-extra/msd_lite
